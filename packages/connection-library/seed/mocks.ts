...
export const games: GameMetadata[] = [
   ...
   },
   {
      ...
      genre: 'Survival game',
      shortDescription: 'Confront the devastating physical and emotional repercussions of Ellie\'s actions.',
   ...
   },
   {
      ...
      shortDescription: 'A breathtaking experience that redefines World War II for a new gaming generation',
      description: 'The game simulates the infantry and combined arms warfare of World War II. An expansion pack, Call of Duty: United Offensive, was developed by Gray Matter Interactive with contributions from Pi Studios and produced by Activision. The game follows American and British paratroopers and the Red Army. \n' +
   ...
   },
   {
      ...
      shortDescription: 'America, 1899. The end of the wild west era has begun as lawmen hunt down the last remaining outlaw gangs. Those who will not surrender or succumb are killed.',
      ...
      gallery: [
          ...
          'https://www.gtabase.com/igallery/2101-2200/RedDead2_GameplayVideo_ArthurMorgan_DutchGang_Uncle_Camp_Poker-2163-360.jpg'
      ],
   },
   {
      id: '7',
      ...
      genre: 'First-person shooter',
      shortDescription: 'Next-gen sequel to the award-winning PC game franchise developed by GSC Game World, set to deliver a unique action experience of survival in the post-apocalyptic Chornobyl Exclusion Zone.',
   ...
   },
   {
      ...
      shortDescription: 'The story is based on Dmitry Glukhovsky\'s novel of the same name, where survivors of a nuclear war have taken refuge in the Metro tunnels of Moscow.',
